...
id<VisualizationController> createVisualizationController(EAGLView * view, CameraCalibration c, CGSize size)
{
  return [[SimpleVisualizationController alloc] initWithGLView:view calibration:c frameSize:size];
}